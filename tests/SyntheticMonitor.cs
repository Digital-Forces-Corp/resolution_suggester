...
static class SyntheticMonitor
{
    public record MonitorDef(
        ...
        string TestModesArg,
        string[] ExpectedModes,  // modes that pass filtering
